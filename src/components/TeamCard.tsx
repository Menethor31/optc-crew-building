...
export default function TeamCard({ team }: TeamCardProps) {
  ...
  return (
    <div className="bg-optc-bg-card border border-optc-border rounded-xl p-4 hover:border-optc-accent/40 group transition-colors">
      <div className="flex items-start gap-3">
        {/* Vote */}
        <div className="flex-shrink-0 pt-1">
          <VoteButton teamId={team.id} initialScore={team.score || 0} compact />
        </div>
        {/* Content */}
